...
export function SupportPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: 'Срок хранения зависит от тарифа: Free — 3 дня, Report и Bundle — 30 дней, подписки sub_monthly/sub_annual — 180 дней.',
    },
    {
      q: 'Что входит в Набор «3»?',
      a: 'Набор включает 3 полных PDF-отчёта для разных людей. Это разовая покупка без подписки, срок хранения отчётов — 30 дней.',
    },
    {
