...
(function (global) {
  ...
  merge('ru', {
    ...
    pricing_sub: 'Каждый платный отчёт отправляется на почту и хранится в кабинете по сроку тарифа: 30 дней (Report/Bundle), 180 дней (подписки).',
    ...
    step_3d: 'Отчёт мгновенно отправляется на email и сохраняется в личном кабинете по сроку тарифа.',
    about_tag: 'О нас',
    ...
    wt_r3: 'PDF 12–14 стр. (срок хранения зависит от тарифа)',
    ...
    step3_summary_forever: 'по сроку тарифа',
  ...
  var EXTRA_RU = {
    ...
    pricing_free_meta: '3 дня хранения',
    ...
    pricing_rep_desc: 'Полная карта с хранением 30 дней',
    ...
    faq_a5: 'PDF-отчёт отправляется на указанный email сразу после расчёта — в течение 60 секунд. Также он сохраняется в кабинете на срок, который зависит от тарифа.',
